...
[source,sh]
----
oc label rev/enter-serverless-functions-00001 app.openshift.io/runtime=quarkus --overwrite
----
...
[source,sh]
----
oc label ksvc/enter-serverless-functions boson.dev/function=true --overwrite
----
